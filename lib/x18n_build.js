...
(function() {
  ...
  base = function(Observable) {
    ...
    X18n = (function(superClass) {
      ...
      X18n.prototype.defaultlocal = 'en';

      X18n.prototype.chosenLocal = void 0;

      X18n.prototype.availableLocales = [];

      X18n.prototype.locales = [];

      X18n.prototype.missingTranslations = {};
      ...
      X18n.prototype.globalEval = function(src) {
