...
(function() {
  ...
  X18n = (function() {
    ...
    X18n.sortLocales = function() {
      var locales;
      locales = [this.chosenLocal].concat(__slice.call(this.similiarLocales(this.chosenLocal)), [this.detectLocal()], __slice.call(this.similiarLocales(this.detectLocal)), [this.defaultlocal], __slice.call(this.similiarLocales(this.defaultlocal)), ['en'], __slice.call(this.similiarLocales('en')), __slice.call(this.availableLocales));
      if (!this.chosenLocal) {
        locales.shift();
      }
